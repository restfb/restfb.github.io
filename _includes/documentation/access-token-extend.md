See <a target="_blank" href="https://developers.facebook.com/docs/facebook-login/access-tokens/expiration-and-extension" class="badge badge-primary">Graph API documentation</a>
